 ...
 */
function parseCsvForPrice(csvContent, targetInstanceId, targetPricingModel, instanceColumnName, modelColumnName, priceColumnName, filePath // For logging
) {
...
const getPricingData = async (req, res) => {
    ...
    corsHandler(req, res, async () => {
        ...
        try {
            ...
            const foundPrice = parseCsvForPrice(contentString, instanceId, pricingModelValue, csvInstanceColumn, csvModelColumn, csvPriceColumn, filePath);
            if (foundPrice !== null) {
